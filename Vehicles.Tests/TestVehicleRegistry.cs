namespace Vehicles.Tests
{
    ...
    public class TestVehicleRegistry
    {
        ...
        {
            registry = new VehicleRegistry(new SimpleOptimizedVehicleDatabase());
        }
        ...
        [TestMethod]
        public void CalculatedTaxWrongYearShouldThrowException()
        {
            var vehicle = registry.GetVehicles().FirstOrDefault();
            Assert.ThrowsException<ArgumentException>(() => registry.UpdateTax(vehicle, 2022), "");
        }
